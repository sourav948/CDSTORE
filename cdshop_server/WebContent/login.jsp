		...
		<div class="wrap">
			<nav id="menu-wrap">    
				<ul id="menu">
					...
					<li><a href="featured.jsp">Store</a></li>
	...
	<div class="wrap">
		<div class="about-grids">
        	...
        	<form action="submitLogin" method="post" name="loginform">
                	<input id="usernameId" name="customerName" type="text" value="" class="field" >
                    <input id="userpasswordId" name="customerPassword" type="password" value="" class="field" >
           ...
           <div class="register_account">
    		...
    		<form id="register_form" action="register" method="post">
		    			...
		    			<div><input id="customer_email" name="customer_email" type="text" value="E-Mail" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-Mail';}"></div>
